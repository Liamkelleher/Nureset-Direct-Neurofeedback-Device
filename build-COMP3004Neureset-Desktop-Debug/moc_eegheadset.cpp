...
#include <memory>
#include "../../COMP3004/FinalProject/COMP3004Neureset/eegheadset.h"
...
QT_MOC_LITERAL(1, 11, 13), // "startAnalysis"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 18) // "getInitialBaseline"

    },
    "EEGHeadset\0startAnalysis\0\0getInitialBaseline"
};
...
void EEGHeadset::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->startAnalysis(); break;
        case 1: _t->getInitialBaseline(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EEGHeadset::startAnalysis)) {
                *result = 0;
                return;
            }
        }
